...
const productos = [
  ...
  {
    nombre: "Dulce de Frutilla",
    imagen: "/images/productos/frutilla.jpg",
    color: "#e1ac48",
    precio: 12000,
    peso: "460g",
  },
  {
    ...
    imagen: "/images/productos/durazno.jpg",
    color: "#95cad3",
    precio: 8000,
    peso: "460g",
  },
      ...
      <section className="flex flex-col text-[#2A2D34] justify-between">
        ...
        <header className="max-w-4xl h-[70vh] flex flex-col justify-center items-center mx-auto px-6 py-16 text-center leading-relaxed">
          <h1 className="text-3xl md:text-4xl font-light">
            Dulces artesanales{" "}
            <span className="font-semibold text-[#b01a2f]">100% naturales</span>
            , elaborados con frutas seleccionadas en el
            <span className="font-medium text-[#9bcb88]">
              {" "}
              Valle de Río Negro
            </span>
            .
