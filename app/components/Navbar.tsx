...
export const Navbar = () => {
  ...
  return (
    <nav className="flex relative justify-center items-center bg-[#F9F9F8]/90 backdrop-blur-sm text-[#2A2D34] px-6 shadow-sm border-b border-[#AEE4EA]/40 min-h-20 z-50">
